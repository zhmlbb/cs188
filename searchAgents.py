    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
          ...
          if not self.walls[nextx][nexty]:
            ...
            newVisited = tuple(sorted(newVisited))  # Keep tuple sorted for consistency
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    while unvisited:
        distances = [(util.manhattanDistance(current, corner), corner) for corner in unvisited]
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    # Use the mazeDistance to the furthest food as heuristic
    # Cache results in heuristicInfo to avoid repeated computation
    maxDist = 0
